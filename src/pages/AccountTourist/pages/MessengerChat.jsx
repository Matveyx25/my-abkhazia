...
import { CardOrdersSmall } from '../../../components/CardEdit/CardOrdersSmall';
      ...
      <div className="messenger-page__row">
        <div className="messenger-page__chat-wrapper">
          <div className="account-page__jcsb">
            <Link className="messenger-page__back-btn" to="../messenger">
        ...
        <div className="messenger-page__right">
          <TouristCard owner={true}/>
          <CardOrdersSmall
